...
@interface ZYImagesPlayer ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)setIndicatorPattern:(id<ZYImagesPlayerIndictorPattern>)indicatorPattern
{
...
{
    [ZYImagesPlayer checkElementOfImages:images];
